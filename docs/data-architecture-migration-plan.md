...
**Backups.** Docs and `pipeline/backup.py` describe backups; **there is no global enforced “backup before pipeline”** hook in code — **gap** vs evaluation Section 9 and Section 12.2.
